...
# CDK creates new VPC
./deploy_latency_hunting.sh --region ap-northeast-1 --key-pair your-keypair

# CDK creates VPC with custom CIDR
./deploy_latency_hunting.sh --region ap-northeast-1 --vpc-cidr 10.200.0.0/16 --key-pair your-keypair
```
